...
.portal {
  ...
  /* ── Text ── */
  --text:#0A0C13; --text2:#3F4655; --muted:#6B7382; --muted2:#6C778B;
  /* ── Accents ── */
  ...
  --green:#0C8560; --green-soft:rgba(14,159,114,.10);
  --amber:#A46A08; --amber-soft:rgba(200,130,10,.12);
  --red:#D63D3D; --red-soft:rgba(217,74,74,.10);
  --blue:#2073DE; --blue-soft:rgba(47,125,225,.10);
  --pink:#D03794; --pink-soft:rgba(211,67,155,.10);
  /* ── Depth ── */
...
.p-signout-btn {
  ...
  border-radius:var(--r-xs); font-size:12.5px; font-family:inherit; cursor:pointer; font-weight:500; box-shadow:var(--sh-1);
...
.p-preview {
  ...
  padding:8px 10px 8px 16px; margin-bottom:26px; font-size:12.5px; color:var(--text2);
}

/* ══ Typography ═════════════════════════════════════════════════════ */
.p-pagehead { display:flex; align-items:flex-start; justify-content:space-between; gap:22px; margin-bottom:30px; flex-wrap:wrap; }
.p-eyebrow {
  display:inline-flex; align-items:center; gap:8px; font-size:11px; font-weight:660;
...
.p-h1 { font-size:29px; font-weight:660; letter-spacing:-.034em; margin:0 0 8px; line-height:1.14; }
...
.p-mission-greet { font-size:12.5px; font-weight:500; color:var(--muted); margin-bottom:12px; display:flex; align-items:center; gap:8px; }
...
.p-mission-cell-val { font-size:20px; font-weight:660; letter-spacing:-.03em; font-variant-numeric:tabular-nums; display:flex; align-items:baseline; gap:8px; }
${down.sm} {
...
.p-quick {
  ...
  padding:8px 12px; border-radius:var(--r-sm); font-size:12.5px; font-weight:500;
...
.p-quick-count { font-size:11px; font-weight:700; padding:1px 8px; border-radius:var(--r-lg); font-variant-numeric:tabular-nums; }
...
.p-ai-eyebrow { font-size:10.5px; font-weight:660; letter-spacing:.09em; text-transform:uppercase; color:var(--accent); }
.p-ai-title { font-size:17px; font-weight:660; margin:4px 0 0; letter-spacing:-.026em; }
...
.p-opp-title { font-size:15px; font-weight:600; letter-spacing:-.024em; line-height:1.35; }
...
.p-opp-fact b { font-size:12.5px; font-weight:600; color:var(--text2); letter-spacing:-.01em; }
...
.p-opp-steps li { display:flex; align-items:flex-start; gap:8px; font-size:12.5px; line-height:1.5; color:var(--text2); }
...
.p-opp-expand {
  ...
  color:var(--accent); font-family:inherit; font-size:12.5px; font-weight:600; cursor:pointer; padding:0;
}
...
.p-tl-title { font-size:13.5px; font-weight:500; letter-spacing:-.012em; line-height:1.4; }
...
.p-tech-finding-title { font-size:13.5px; font-weight:600; letter-spacing:-.014em; line-height:1.4; }
.p-tech-finding-url {
...
.p-sectionlabel h2 { font-size:15px; font-weight:660; letter-spacing:-.024em; margin:0; }
...
.p-panel-title { font-size:15px; font-weight:660; letter-spacing:-.024em; margin:0; display:flex; align-items:center; gap:8px; }
.p-panel-sub { font-size:12.5px; color:var(--muted); line-height:1.6; margin:-12px 0 16px; }
.p-badge { font-size:11px; font-weight:600; padding:2.4px 8px; border-radius:var(--r-lg); background:var(--surface2); color:var(--muted); border:1px solid var(--line); }
...
.p-btn {
  ...
  font-size:13px; font-weight:600; letter-spacing:-.012em; padding:9.4px 16px; border-radius:var(--r-sm);
  cursor:pointer; border:1px solid transparent; text-decoration:none; white-space:nowrap;
  transition:filter var(--dur-2), border-color var(--dur-2), color var(--dur-2), box-shadow var(--dur-2), transform var(--dur-2);
}
.p-btn.primary {
  background:linear-gradient(145deg,var(--accent3),var(--accent) 48%,var(--accent2)); color:#fff;
...
.p-kpi-val { font-size:29px; font-weight:660; letter-spacing:-.038em; line-height:1.04; font-variant-numeric:tabular-nums; }
...
.p-score-label { font-size:12.5px; font-weight:600; color:var(--text2); letter-spacing:-.014em; }
...
.p-onboard-title { position:relative; font-size:15px; font-weight:660; margin:0; letter-spacing:-.024em; }
...
.p-empty-title { font-size:15px; font-weight:660; color:var(--text); margin-bottom:7px; letter-spacing:-.022em; }
...
.p-priority-text { font-size:13.5px; font-weight:500; line-height:1.45; letter-spacing:-.012em; }
...
.p-exec-label { font-size:10.5px; font-weight:660; letter-spacing:.09em; text-transform:uppercase; color:var(--accent); margin-bottom:7px; }
.p-exec-text { font-size:14px; line-height:1.72; color:var(--text2); margin:0; }

/* ══ Tables ═════════════════════════════════════════════════════════ */
.p-table { width:100%; border-collapse:collapse; }
.p-table th { text-align:left; font-size:11px; font-weight:600; letter-spacing:.03em; color:var(--muted); padding:0 12px 12px; border-bottom:1px solid var(--line); white-space:nowrap; }
...
.p-table-sort { background:none; border:0; font:inherit; font-size:11px; font-weight:600; letter-spacing:.03em; color:var(--muted); cursor:pointer; padding:0; display:inline-flex; align-items:center; gap:4px; transition:color var(--dur-2); }
...
.p-pos { display:inline-flex; min-width:31px; justify-content:center; font-size:11.5px; font-weight:660; padding:4px 8px; border-radius:var(--r-xs); background:var(--surface3); color:var(--muted); font-variant-numeric:tabular-nums; }
...
.p-chip { font-size:11px; font-weight:500; padding:2.4px 8px; border-radius:var(--r-xs); background:var(--surface2); color:var(--muted); border:1px solid var(--line-soft); text-transform:capitalize; white-space:nowrap; }
...
.p-pager-btn { background:var(--surface); border:1px solid var(--line); color:var(--text); padding:7.4px 14px; border-radius:var(--r-sm); font-family:inherit; font-size:12.5px; cursor:pointer; box-shadow:var(--sh-1); transition:all var(--dur-2) var(--ease-out); }
...
.p-stattile-val { font-size:22px; font-weight:660; letter-spacing:-.034em; line-height:1.14; font-variant-numeric:tabular-nums; }
...
.p-rec-title { font-size:13.5px; font-weight:600; line-height:1.4; letter-spacing:-.018em; }
...
.p-review-quote { background:var(--surface2); border-left:2.5px solid var(--accent-line); border-radius:0 var(--r-sm) var(--r-sm) 0; padding:12px 16px; font-size:12.5px; line-height:1.68; color:var(--muted); font-style:italic; margin-bottom:14px; }
...
.p-tip-row { display:flex; align-items:center; justify-content:space-between; gap:16px; font-size:12.5px; padding:2.4px 0; }
...
.p-def dt { font-size:12.5px; color:var(--muted); font-weight:500; min-width:162px; }
...
.p-wb-promo {
  ...
  background:linear-gradient(135deg, rgba(46,125,90,.12), rgba(20,60,45,.06));
  border:1px solid rgba(46,125,90,.28); border-radius:var(--r-md);
}
.p-wb-promo-eyebrow { font-size:11px; letter-spacing:.12em; text-transform:uppercase; color:var(--muted2); margin-bottom:6px; }
.p-wb-promo-title { margin:0 0 6px; font-size:16px; font-weight:700; letter-spacing:-.02em; }
...
.p-cap-status-access_required { color:var(--muted2); }
.p-cap-summary { margin:0; font-size:12px; color:var(--muted); line-height:1.5; }
.p-cap-details { margin-top:8px; padding-top:8px; border-top:1px solid var(--line-soft); font-size:12px; color:var(--muted); line-height:1.55; }
...
.p-chat-welcome-title { font-size:22px; font-weight:660; margin:0 0 8px; letter-spacing:-.03em; }
...
.p-chat-suggestion { background:var(--surface); border:1px solid var(--line); color:var(--text2); padding:9.4px 16px; border-radius:var(--r-lg); font-family:inherit; font-size:12.5px; cursor:pointer; text-align:left; box-shadow:var(--sh-1); transition:border-color var(--dur-2), color var(--dur-2), transform var(--dur-2); }
...
.p-msg-avatar { width:30px; height:30px; border-radius:var(--r-sm); background:linear-gradient(145deg,var(--accent3),var(--accent) 48%,var(--accent2)); color:#fff; display:flex; align-items:center; justify-content:center; flex-shrink:0; margin-top:2px; box-shadow:0 3px 10px var(--accent-glow); }
.p-msg-bubble { max-width:min(680px,80%); padding:14px 16px; border-radius:var(--r); font-size:13.5px; line-height:1.72; white-space:pre-wrap; word-break:break-word; }
...
.p-chat-error { font-size:12.5px; color:var(--red); background:var(--red-soft); padding:12px 16px; border-radius:var(--r-sm); }
...
.p-report-title { font-size:24px; font-weight:660; margin:0 0 6px; letter-spacing:-.034em; }
.p-report-period { font-size:12.5px; color:var(--muted); }
.p-report-section { margin-bottom:30px; }
.p-report-section h3 { font-size:11px; font-weight:660; text-transform:uppercase; letter-spacing:.08em; color:var(--muted); margin:0 0 14px; }
@media print {
...
function darkVars() {
  ...
  --text:#F3F5F8; --text2:#B2B9C6; --muted:#7F8797; --muted2:#747E8F;
